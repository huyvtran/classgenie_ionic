...
app1.controller('profilectrl',['$scope','$location','$window','$ionicPopup','$cordovaCamera','$http','$state','$ionicModal','$cordovaFileTransfer','$ionicHistory','$ionicLoading',function($scope,$location,$window,$ionicPopup,$cordovaCamera,$http,$state,$ionicModal,$cordovaFileTransfer,$ionicHistory,$ionicLoading){
     ...
     $scope.editprofile=function(){
        if($scope.selection=="0"){
           ...
           else
            {
                     ...
                     $cordovaFileTransfer.upload(global.config['api_url']+'/student/updateimage?token='+Service_Store.getLocal('app_token'), $scope.imageName, options).then(function (result) {
...
$scope.deleteaccount = function(){
   ...
   ajaxloader.loadURL(global.config['api_url']+'/'+$scope.url+'/delete?token='+Service_Store.getLocal('app_token')+'&member_no='+member_no,{},$scope.studentDeleteResponse = function(resp){
