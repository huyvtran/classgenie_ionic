    ...
    */
    notification.controller('notification_setting_studentsCtrl',['$scope','$ionicPopup','$location','$window', '$ionicLoading','$cordovaPush','$cordovaDevice', function($scope,$ionicPopup,$location,$window,$ionicLoading,$cordovaPush,$cordovaDevice){
           loader.dependency = $ionicLoading;
           $scope.Notification_Settings = {};
           $scope.member_no = $.trim(Service_Store.getLocal('das_student_no'));
