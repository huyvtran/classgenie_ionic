    ...
    */
    notification.controller('notification_settingCtrl',['$scope','$ionicPopup','$location','$window', '$ionicLoading','$cordovaPush','$cordovaDevice', function($scope,$ionicPopup,$location,$window,$ionicLoading,$cordovaPush,$cordovaDevice){
